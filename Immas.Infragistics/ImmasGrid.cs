...
namespace Immas.Infragistics
{
    public partial class ImmasGrid : UltraGrid
    {
        ...
        private void Initialize_ColorSetting()
        {
            ...
            this.DisplayLayout.Override.SelectedRowAppearance.BackColor = CommonColorSet.ActiveCellBackColor;
            ...
            this.DisplayLayout.Override.ActiveCellColumnHeaderAppearance.BackColor  = CommonColorSet.ActiveCellHeaderColor;
            this.DisplayLayout.Override.ActiveCellBorderThickness = 1;

            this.DisplayLayout.Override.HeaderAppearance.BackColor      = CommonColorSet.HeaderBackColor; 
        ...
        public void LoadGridSchema(string fileName)
        {
            ...
            using (var stream = new FileStream(@"Grid\" + fileName, FileMode.Open))
            {
